  ...
  <nav style={{
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
      <button onClick={() => setPage("landing")} style={{ display: "flex", alignItems: "center", gap: 10, background: "none", border: "none", cursor: "pointer" }}>
        <Image src={avelonLogo} alt="Avelon Logo" width={115} height={115} />
      </button>
      <div style={{ display: "flex", gap: 32, marginLeft: 8 }}>
        {["Home", "About", "How It Works"].map((item: string) => (
...
const LandingPage = ({ setPage }: { setPage: (p: Page) => void }) => (
  <>
    ...
    <div style={{ 
      ...
      margin: 0,
      padding: 0,
      background: "linear-gradient(135deg, #ffffff 0%, #fefefe 50%, #f8f9fa 100%), radial-gradient(ellipse at top left, rgba(232,92,26,0.05) 0%, transparent 150%), radial-gradient(ellipse at bottom right, rgba(255,140,90,0.03) 0%, transparent 150%)", 
      fontFamily: "'Sora', sans-serif", 
      position: "relative", 
      overflow: "hidden",
    ...
    {/* Hero */}
    <div style={{ width: "100%", padding: "64px 0 48px", display: "flex", alignItems: "center", gap: 48, position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
      <div style={{ flex: 1, position: "relative" }}>
        ...
        <h1 style={{ fontSize: 52, fontWeight: 800, lineHeight: 1.1, color: "#111", margin: "0 0 20px", letterSpacing: -1.5, position: "relative", zIndex: 2 }}>
          Grow Your Assets by<br />
          <span style={{ color: "#E85C1A" }}>Providing Liquidity</span>
        </h1>

        <p style={{ fontSize: 15, color: "#9CA3AF", lineHeight: 1.7, marginBottom: 36, maxWidth: 440, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40, position: "relative", zIndex: 2 }}>
          {[
    ...
    {/* Divider */}
    <div style={{ width: "100%", padding: "0", position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
    ...
    {/* About */}
    <div style={{ width: "100%", padding: "0", position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto 64px" }}>
      <div style={{
...
const AuthPage = ({ mode, setPage }: { mode: "login" | "signup"; setPage: (p: Page) => void }) => {
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{
              ...
              <button onClick={() => setShowPass(v => !v)} style={{ background: "none", border: "none", cursor: "pointer", padding: 0 }}>
